    ...
    CONFIG.DND5E.classFeatures = {
        "barbarian": {
            "subclasses": {
                ...
                "path-of-the-juggernaut": {
                    ...
                    "source": "Shattered Scales",
                    "features": {
                    }
                },
                "path-of-the-warlord": {
                    "label": "Path of the Warlord",
                    "source": "Shattered Scales",
                    "features": {
                    }
                },
        ...
        "bard": {
            "subclasses": {
                ...
                "college-of-healing": {
                    "label": "College of Healing",
                    "source": "Shattered Scales",
                    "features": {
                        "3": ["Compendium.shattered-scales.class-features.BsZczKETUA6D5u2a", "Compendium.shattered-scales.class-features.0k3fo59eIbkPL7s1"],
                        "6": ["Compendium.shattered-scales.class-features.LCMcLklNfAO7I94D", "Compendium.shattered-scales.class-features.u4Gz7ToBEuYayHFp"],
                        "14": ["@Compendium.shattered-scales.class-features.fF59jv8j5YMajlXi", "Compendium.shattered-scales.class-features.M0w62b7qZ2iytJ3Q"],
                    }
                },
                "college-of-trickery": {
                    "label": "College of Trickery",
                    "source": "Shattered Scales",
                    "features": {
        ...
        "shaman": {
            "subclasses": {
                "corval-the-watchful": {
                    "label": "Corval the Watchful",
                    "source": "Shattered Scales",
                    "features": {

                    }
                },
                "fenris-primarch-of-wolves": {
                    "label": "Fenris, Primarch of Wolves",
                    "source": "Shattered Scales",
                    "features": {
                        
                    }
                },
                "keyvah-the-night-stalker": {
                    "label": "Keyvah the Night Stalker",
                    "source": "Shattered Scales",
                    "features": {
                        
                    }
                },
                "koda-greatfather-of-the-kodiak": {
                    "label": "Koda, Greatfather of the Kodiak",
                    "source": "Shattered Scales",
                    "features": {
...
class CustomClasses {
    static async exportList() {
        const packData = await game.packs.get("custom-classes.classfeatures").getContent()
